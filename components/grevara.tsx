...
export function Grevara() {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-none landscape:max-w-[90%] 2xl:max-w-[90%] px-5 py-12 lg:py-14 sm:px-8">
      ...
      {showCatalog && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 backdrop-blur-md bg-black/70">
          <div className="relative w-full max-w-none landscape:max-w-[90%] 2xl:max-w-[90%] h-full max-h-[96vh] rounded-3xl shadow-[0_0_80px_-15px_rgba(251,191,36,0.3)] flex flex-col animate-in fade-in zoom-in duration-300 p-[1px] bg-gradient-to-br from-amber-400/50 via-purple-500/20 to-purple-600/50">
