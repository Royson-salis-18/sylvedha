        ...
        <nav className="hidden items-center gap-1 md:flex">
          {navLinks.map((link) => (
            <a
              key={link.href}
              href={link.href}
              className="rounded-xl px-4 py-2 text-sm text-white bg-black/40 backdrop-blur-md border border-white/5 transition-all duration-300 hover:bg-white/10 hover:text-[#BFF202] font-medium"
            >
              {link.label}
            </a>
          ))}
